        ...
        <div className="flex h-max w-full max-w-[400px] flex-col gap-6 md:sticky md:top-2 md:max-w-[350px]">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-col gap-1 rounded-md border-[1px] border-gray-700 bg-gray-800 p-2">
              <h2 className="font-bold">Salary in {format(selectedMonthAsDate, "MMMM")}</h2>
              <span>{formatCurrency(salary)}</span>
            </div>

            <div className="flex flex-col gap-1 rounded-md border-[1px] border-gray-700 bg-gray-800 p-2">
              <h2 className="font-bold">Salary in {format(selectedMonthAsDate, "yyyy")}</h2>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1 rounded-md border-[1px] border-gray-700 bg-gray-800 p-2">
              ...
              <span>
                {highestWorkdaysMonth.workDays} workdays, {highestWorkdaysMonth.workedHours} h
              </span>
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-7 gap-1">
                      {days.map((day) => {
                        const dayWithDetails = daysWithDetails.get(formatDay(day))!;
